...
import { FaPlay, FaPause, FaSyncAlt, FaUndo, FaForward, FaVolumeUp, FaVolumeDown } from 'react-icons/fa';
...
const RecapNewTues = () => {
  ...
  // console.log({ recapId, deviceType });
  ...
  useEffect(() => {
    const fetchRecapDetail = async () => {
      try {
        ...
        const recapList = resolveRefs(response.data.data);
        setRecap(recapList);
      ...
      const currentVersion = recapList.currentVersion;
