...
import '../BookTrending/BookTrendingDetail.scss';
//import AudioGrid from '../BookListen/AudioGrid';
import AudioGrid from '../../TodayFreeRead/BookListen/AudioGrid';
const BookTrendingDetail = () => {
    ...
    <div className="book-detail-container">
      <div className="book-detail-content">
        ...
        <div className="book-detail-actions">
          <button className="action-button read-button" onClick={handleReadClick}>Listen</button>
          <button className="action-button play-button" onClick={handleListenClick}>Read</button>
        </div>
...
export default BookTrendingDetail;
