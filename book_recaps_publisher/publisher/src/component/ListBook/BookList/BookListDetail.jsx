  ...
  const getBookData = async (fromDate, toDate) => {
    ...
    try {
      ...
      setBookData({
        ...
        unpaidEarnings: bookData.unpaidEarnings || 0,
        totalViews: bookData.totalViews || 0,
        totalWatchTime: bookData.totalWatchTime || 0,
    ...
    <div className="book-detail">
      ...
      <p>
       ...
       {/* <div className="total-earnings">
         ...
         {/* Thêm các thông tin Unpaid Earnings, Total Views, Total Watch Time, Total Earnings, Last Payout */}
        
      </div>
      <div className="stat-container">
              <div className="stat-item">
                <p>
                  <strong>Lần quyết toán gần nhất:</strong>{" "}
                  {bookData.lastPayout.amount}đ (
                  {bookData.lastPayout.fromDate.split("T")[0]} -- 
                  {bookData.lastPayout.toDate.split("T")[0]})
                </p>
              </div>

              <div className="stat-item">
                <p><strong>Số tiền chưa thanh toán:</strong> {bookData.unpaidEarnings} đ</p>
              </div>
              <div className="stat-item">
                <p><strong>Lượt xem:</strong> {bookData.totalViews}</p>
              </div>
              <div className="stat-item">
                <p><strong>Thời lượng xem:</strong> {bookData.totalWatchTime} giây</p>
              </div>
              <div className="stat-item">
                <p><strong>Thu nhập hiện tại:</strong> {bookData.totalEarnings} đ</p>
              </div>
      </div>
      ...
      <Box sx={{ padding: 4, width: "70vw",marginTop: "25cm"  }}>
