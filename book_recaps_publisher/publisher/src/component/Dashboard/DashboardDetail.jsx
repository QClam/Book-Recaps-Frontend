...
const DashboardDetail = () => {
  ...
  return (
    ...
    <div className="book-detail">
      ...
      {/* <div>    
      <p><strong>Total Earnings:</strong> {totalEarnings ? totalEarnings : 'No earnings available'}</p>
    </div> */}
      </div>
      ...
      <Box sx={{ padding: 4, width: "70vw",marginTop: "15cm"  }}>
        ...
        {/* <Typography variant="h5" color="primary">
          {`Thu nhập: ${(bookData.lastPayout?.earning ?? 0).toLocaleString("vi-VN")} VND`}
        </Typography> */}
        {/* Gộp phần hiển thị totalEarnings vào Box */}
        <Typography variant="h6" color="secondary" sx={{ marginTop: 1 }}>
        <strong>Total Earnings:</strong> {totalEarnings ? totalEarnings.toLocaleString("vi-VN") + ' đ' : 'No earnings available'}

        </Typography>
      </Box>
        <Box>
          <Typography textAlign="center" sx={{ marginBottom: 2 }}>
            Hãy chọn khoảng thời gian để hiển thị số liệu
          </Typography>
          <Box display="flex" justifyContent="center">
            <DateRangePicker format="dd-MM-yyyy" onChange={handleDateChange} />
          </Box>
        </Box>
        <Card>
          <CardContent>
